    ...
    <div className="bg-background-light dark:bg-background-dark font-display h-full w-full overflow-hidden flex flex-col relative selection:bg-primary selection:text-white">
        ...
        <main className="relative z-10 flex flex-col h-full px-6 md:px-8 pt-safe-pt pb-safe-pb max-w-3xl mx-auto w-full">
            <div className="flex-1 flex flex-col items-center justify-center min-h-0">
                <header className="flex flex-col items-center justify-center mb-6 animate-fade-in-down">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-primary/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-primary/30 mb-4 shadow-[0_0_20px_rgba(17,82,212,0.4)] relative overflow-hidden group">
                    ...
                    <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-widest uppercase text-white">MangaShelf</h1>
                </header>
                ...
                <div className="flex flex-col items-start space-y-3 px-2">
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-white leading-[1.15] tracking-tight">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-slate-300 font-light leading-relaxed max-w-xs md:max-w-md">
                        Scan, track, and grow your library—without spreadsheets.
                    </p>
                </div>
            </div>

            <div className="flex flex-col items-center gap-4 w-full pt-4 pb-4 shrink-0">
