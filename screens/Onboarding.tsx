        ...
        <main className="relative z-10 flex flex-col h-full px-6 pt-safe-pt pb-safe-pb">
            <div className="flex-1 flex flex-col items-center justify-center min-h-0">
                <header className="flex flex-col items-center justify-center mb-12 animate-fade-in-down">
                    <div className="w-20 h-20 bg-primary/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-primary/30 mb-6 shadow-[0_0_20px_rgba(17,82,212,0.4)] relative overflow-hidden group">
                        <div className="absolute inset-0 bg-primary/10 blur-xl opacity-50"></div>
                        <svg className="text-primary w-10 h-10 relative z-10 drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary rounded-full blur-[120px] opacity-20 pointer-events-none"></div>
